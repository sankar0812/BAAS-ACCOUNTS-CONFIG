...
SMTP_SUBJECT="[TEST] - [DEPLOYMENT STARTS] : TEST_BASS-ACCOUNTS-GATEWAY"_${BUILD_NUMBER}
SMTP_BODY="Automated Deployment for TEST_BASS-ACCOUNTS-GATEWAY has been initiated by code change in the origin/develop branch, please stand by, an email will be sent after deployment has been completed."
