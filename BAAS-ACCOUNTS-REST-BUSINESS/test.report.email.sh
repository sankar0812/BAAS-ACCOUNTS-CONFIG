...
SMTP_SUBJECT="[TEST FAILED] - [DEPLOYMENT ENDS]: DEV-BAAS-ACCOUNTS-REST-BUSINESS"
SMTP_BODY="The Test cases are failed. So,the code is reverted back and attached the test report.Check the code once again."
SMTP_ATTACHMENT="/ops/jenkins/workspace/DEV-BAAS-ACCOUNTS-REST-BUSINESS/test-report.html"
