...
SMTP_SUBJECT="[TEST FAILED] - [DEPLOYMENT ENDS]: DEV_BAAS-ACCOUNTS-REST-DATA-ACCESS"
SMTP_BODY="The Test cases are failed. So,the code is reverted back and attached the test report.Check the code once again."
SMTP_ATTACHMENT="/ops/jenkins/workspace/DEV_BAAS-ACCOUNTS-REST-DATA-ACCESS/test-report.html"
